...
open class Chart: UIControl {
    ...
    */
    open var xLabelsFormatter = { (labelIndex: Int, labelValue: Double) -> String in
        String(Double(labelValue))  // ospr's answer https://stackoverflow.com/questions/37063042/y-axis-is-repeating-values-ios-charts
   //     String(Int(labelValue))   ////// default
    }
...
open var xLabelsTextAlignment: NSTextAlignment = .center
    ...
    */
    ...
    //-------------i added below "x-axis" line to get the x-axis labels centered ----------------
open var xLabelsSkipLast: Bool = false
    //-------------------------------------------------------------------------------------------
     //-------------------------------------------------------------------------------------------
open var yLabelsSkipLast: Bool = false
     //-------------------------------------------------------------------------------------------
    /**
 ...
 open var axesColor: UIColor = UIColor.black
    /**
    Color for the grid.
    */
    @IBInspectable
   open var gridColor: UIColor = UIColor.gray.withAlphaComponent(0.01)
...
open var bottomInset: CGFloat = 0 //i tried this
    /**
 ...
 open var topInset: CGFloat = 0 //i tried this
    // -------------------------------------
 ...
 // open var lineWidth: CGFloat = 2
    ...
    */
    open var highlightLineColor = UIColor.gray //// default
   // open var highlightLineColor = UIColor.white
    ...
    */
    ...
    private func commonInit() { // CHANGES BACKGROUND COLOR tag: Fill !!!
        backgroundColor = UIColor.white
        //backgroundColor = UIColor.clear //// default
    ...
    */
    open func add(_ series: ChartSeries) {
        ...
        //        self.series.append(series)        ////default
    ...
    */
    ...
    fileprivate func drawIBPlaceholder() {
       ...
       // placeholder.backgroundColor = UIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 1)
        placeholder.backgroundColor = UIColor(red: 0.93, green: 0.93, blue: 0.93, alpha: 1) //// default       not sure what this does yet...
        let label = UILabel()
        label.text = "Chart"
        //label.font = UIFont.systemFont(ofSize: 28)
        label.font = UIFont.systemFont(ofSize: 12)
        label.textColor = UIColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0) //// white I thinkk
       // label.textColor = UIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 1.0) //// black I think
    ...
    fileprivate func drawAxes() {
        ...
        context.move(to: CGPoint(x: CGFloat(0), y: drawingHeight))
        context.addLine(to: CGPoint(x: CGFloat(drawingWidth), y: drawingHeight))
      ...
      context.addLine(to: CGPoint(x: CGFloat(0), y: drawingHeight + topInset))
        context.addLine(to: CGPoint(x: CGFloat(0), y: drawingHeight))
    ...
    //    context.setLineWidth(0.5)
        ...
        scaled.enumerated().forEach { (i, value) in
            let x = CGFloat(value)
          //  let isLastLabel = x == drawingHeight
                    let isLastLabel = x == drawingWidth ////default

//------------------------------------------------------------------
            //// not sure if this is from default or not, found online
...
//------------------------------------------------------------------
            ...
            // Add label
            let label = UILabel(frame: CGRect(x: x-7.0, y: drawingHeight + 3.0, width: 0, height: 0)) //NOTE making the "x" a less negative number shifts the labels to the left making a more positive "y" will move the x-axis labels further down below the bottom horizontal line
       //     let label = UILabel(frame: CGRect(x: x, y: drawingHeight, width: 0, height: 0)) //default
...
//----------------------------
        //-------- trying to use x-axis methodology to get y-axis labels like x-axis values
       // var labels: [Double]
        if yLabels == nil {
            // Use labels from the first series
            labels = series[0].data.map({ (point: ChartPoint) -> Double in
...
//-------- trying to use x-axis methodology to get y-axis labels like x-axis values
            let y = CGFloat(value)
             let isLastLabel = y != drawingHeight
//----------------------------------------------------------------------------------
//// ----------- if you comment out section you get no horizontal grid lines just FYI -----------------
         //   // Add horizontal grid for each label, but not over axes
            if y != drawingHeight + topInset && y != zero {
//if y != drawingHeight && y != zero {
                context.move(to: CGPoint(x: CGFloat(0), y: y))
...
////-------------------------------------------------------------------------------------------------
            ///
            let label = UILabel(frame: CGRect(x: -19, y: y-6.5, width: 0, height: 0)) //NOTE: make "x" a less negative number results in shifting the number to the left the "y" is for up and down movement
            //            let label = UILabel(frame: CGRect(x: padding, y: y, width: 0, height: 0)) //default code
            ...
            label.sizeToFit()
//-------- trying to use x-axis methodology to get y-axis labels like x-axis values--------
            if yLabelsSkipLast && isLastLabel {
                // Do not add label at the most right position
                return
            }
//----------------------------------------------------------------------------------
...
//            path.addLine(to: CGPoint(x: left, y: drawingHeight + topInset))
            path.addLine(to: CGPoint(x: left, y: drawingHeight))
