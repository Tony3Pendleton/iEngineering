...
class ThermodynamicsFugacityPureComponentMixtureRedlichKwongVaporEOSViewController: UIViewController {
    ...
    @IBAction func myButton2(_ sender: Any) {
        ...
        if firstValue != nil && secondValue != nil && thirdValue != nil && fifthValue != nil && sixthValue != nil && sixteenthValue != nil  {
