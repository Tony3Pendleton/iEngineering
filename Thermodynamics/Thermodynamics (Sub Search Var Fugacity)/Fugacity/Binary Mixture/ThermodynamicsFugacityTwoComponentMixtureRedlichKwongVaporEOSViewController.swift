...
class ThermodynamicsFugacityTwoComponentMixtureRedlichKwongVaporEOSViewController: UIViewController {
...
//        myLabel30.isHidden = false
        ...
        if firstValue != nil && secondValue != nil && thirdValue != nil && fourthValue != nil && fifthValue != nil && sixthValue != nil && eighthValue != nil && ninthValue != nil && tenthValue != nil && sixteenthValue != nil  {
            ...
            let alpha_1 = Double(pow((firstValue! / fifthValue!), -0.5))
            // ================================================
            // ================ Component 2 ====================

            let alpha_2 = Double(pow((firstValue! / ninthValue!), -0.5))
            // ================================================
            // ================ Component 3 ====================
